...
Генерація фірмових комерційних пропозицій через Anthropic API: меню «КП»
(лише керівник відділу) — складання з файлів ТХ (PDF/DOCX/XLSX/фото),
бібліотека згенерованих DOCX з фільтром за типом обладнання, редаговані
шаблони промптів за напрямами. Деталі — у `PATCH12.md`; фірмові ассети
обкладинки — `assets/kp/README.md`.
